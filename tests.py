...
def test_logic_digit_groups_in_square_simple():
    # given_board = [
    #     [7, 2, 5, 6, 8, 1, 3, 4, 9],
    #     [8, 9, 4, 5, 7, 3, 2, 6, 1],
    #     [6, 1, 3, 9, 2, 4, 7, 8, 5],
    ...
    # this only test the 1st square
    given_board = [
        [[5, 7], [1, 2, 8], [5, 7],     [6], [8], [1], [3], [4], [9]],
        [[1, 8], [9], [1, 4, 8],        [5], [7], [3], [2], [6], [1]],
        [[6], [1, 8], [3],              [9], [2], [4], [7], [8], [5]],
    ...
    sudoku.board = given_board
    sudoku.logic_same_digits_groups_in_square()
    assert sudoku.board == expected_board
